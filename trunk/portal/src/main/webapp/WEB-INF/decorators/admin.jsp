            ...
            <div class="page-sidebar navbar-collapse" style="min-height: 500px">
                ...
                <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <shiro:hasRole name="admin">
                        ...
                        <li>
                                <%--href="${ctx}/datatest" onclick="showTable()"--%>
                            <a href="${ctx}/datatest">
                                <i class="icon-layers"></i>
                                <%--<div style="">--%>
...
<script type="text/html" id="tableNameTempl">
    ...
    <%--<li><a href="${ctx}/showTableData?tableName={{value}}">{{value}}</a></li>--%>
    <li style="text-align: center; border-bottom: 1px #cad9ea solid" ><a href="javaScript:void(0)" onclick="editTableData(this,1)" id="{{value}}">{{value}}</a></li>
    {{/each}}
</script>
