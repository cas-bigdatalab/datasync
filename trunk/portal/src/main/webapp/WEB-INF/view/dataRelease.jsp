            ...
            <table class="0" cellspacing="0" border="0" align="center">
                <tr>
                    ...
                    <shiro:hasRole name="admin">
                        ...
                        <%--</button>--%>
                        <td class="bianji"><a href="#" onclick="editdatarelease(this)" keyIdTd="{{value.id}}">
                    ...
                    <shiro:hasRole name="admin">
                        ...
                        <%--</button>--%>
                        <td class="chakan"><a href="#" onclick="showData('{{value.id}}','{{value.publicType}}','{{value.status}}')">
                    ...
                    <shiro:hasRole name="admin">
                        ...
                        <%--</button>--%>
                        <td class="shanchu"><a href="#"  onclick="removeData('{{value.id}}');"><i class="fa fa-window-close-o" aria-hidden="true"></i> 删除</a>
                        </td>
                    </shiro:hasRole>
                    ...
                    <shiro:hasRole name="root">
                        ...
                        <%--</button>--%>
                        <td class="shenhe"><a href="#" onclick="auditRelease('{{value.id}}')">
                        ...
                        <%--</button>--%>
                        <td class="shanchu"><a href="#" onclick="disableRelease('{{value.id}}')">
